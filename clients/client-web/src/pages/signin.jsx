...
import opsapSymbol from '../../public/opsap6-symbol-final.png'

export default function Signin() {
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center w-auto h-16 mx-auto margin-auto">
          <Image width={55} height={55} src={opsapSymbol} alt="opsap logo" />
        </div>
