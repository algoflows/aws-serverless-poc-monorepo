  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center overflow-x-hidden">
        <div className="p-8">
          <motion.div
              whileHover={{scale: 1.01, y: "5px"}}
            whileTap={{ scale: 0.97 }}
            className="max-w-sm p-4 overflow-hidden shadow-xl cursor-pointer border border-gray-200 rounded-lg transition hover:shadow-xl"
          >
            <div>
              <Image
                width="420"
            ...
            <div className="px-6 pt-4 pb-2 flex justify-between">
              <span className="text-xs text-blue-700 cursor-pointer">See more</span>
              <div className="flex mt-4 mb-2 -mx-2 md:mt-0 md:mb-0">
                <a href="#" className="mx-2 text-gray-300 hover:text-gray-500">
